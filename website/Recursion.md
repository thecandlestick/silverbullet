...
What you need to avoid in a recursive algorithm is _redundant sub-problems_. Taking a _top-down_ approach (starting at i and working towards the base case of 1 or 2) causes you to re-compute a lot of information that you already know, sometimes several times.
