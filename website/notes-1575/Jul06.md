...
Date: 2023-07-06
Recording: https://umsystem.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=53a97965-53db-4388-b9ab-b037014135b5

Reminders:
* [x] Pa03 due tomorrow

Objectives:
* [x] Continuing recursion
...
What you need to avoid in a recursive algorithm is _==redundant sub-problems==_. Taking a _top-down_ approach (starting at i and working towards the base case of 1 or 2) causes you to re-compute a lot of information that you already know, sometimes several times.
...
4.     place row-th queen at `col`
5.     if no more queens
6.       return success
7.     trial <- try-queen(row+1)
